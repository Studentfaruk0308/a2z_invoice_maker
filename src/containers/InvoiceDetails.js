...
import { getInvoice, sendEmailInvoice } from '../api/InvoicesApi'
    ...
    <div className="mx-auto bg-slate-300 mb-4 w-screen">
      <div ref={printingRef} className="px-12 py-12 flex flex-col min-h-screen">
          <div className='flex flex-col'>
                ...
                <div className='flex bg-slate-200 rounded-lg px-4 my-8'>
                  <div class='flex-auto'>
                ...
                {/* calculation */}
                <div className=' bg-slate-200 rounded-lg pt-4 mb-8'>
              ...
              <button className="bg-white rounded-xl px-4 py-2 mt-4 active:bg-slate-700 mr-4" onClick={() => navigate(`/invoices/create`, { state: {invoice: invoiceData}})}>Copy</button>
